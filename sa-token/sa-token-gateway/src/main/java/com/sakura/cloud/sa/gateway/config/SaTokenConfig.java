package com.sakura.cloud.sa.gateway.config;
...
//                    SaRouter.match("/api/user/info", () -> StpUtil.checkPermission("api:user:info"));
                ...
                .setError(e -> {
                    ...
                    context.getResponse().getHeaders().set("Content-Type", "application/json; charset=utf-8");
                    return SaResult.error().setCode(401).set("message", e.getMessage());
                });
    }
}
